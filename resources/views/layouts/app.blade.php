...
<head>
  ...
  <meta name="description" content="@yield('meta_description', 'Notorious cung cấp các dòng sản phẩm thời trang thể thao cao cấp với phong cách tối giản. Khám phá bộ sưu tập mới nhất ngay hôm nay.')">
  ...
  <meta property="og:description" content="@yield('meta_description', 'Notorious cung cấp các dòng sản phẩm thời trang thể thao cao cấp với phong cách tối giản.')">
  ...
  <meta property="twitter:description" content="@yield('meta_description', 'Notorious cung cấp các dòng sản phẩm thời trang thể thao cao cấp với phong cách tối giản.')">
