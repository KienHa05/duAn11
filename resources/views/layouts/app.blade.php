...
<body class="bg-white text-black font-sans antialiased selection:bg-black selection:text-white">
    <div x-data="cartStore()" @cart-updated.window="updateCart($event)" class="min-h-screen flex flex-col">
        <!-- Apple-Style Header -->
        ...
        <footer class="bg-gray-50 border-t border-gray-100 pt-20 pb-12">
            <div class="container mx-auto px-4 max-w-7xl">
                <div class="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
                    <div class="md:col-span-1 space-y-6 text-center md:text-left">
                        <a href="/" class="flex flex-col items-center md:items-start group">
                            <div class="w-10 h-10 rounded-lg bg-black flex items-center justify-center text-white font-black text-lg group-hover:scale-105 transition-transform duration-300">
                                N
                            </div>
                    ...
                    <div class="md:col-span-3 grid grid-cols-2 lg:grid-cols-3 gap-8">
                        ...
                        <div class="space-y-4 col-span-2 lg:col-span-1">
                            ...
                            <div class="flex gap-4">
                                <a href="#" class="w-8 h-8 rounded-full bg-white border border-gray-100 flex items-center justify-center hover:bg-black hover:text-white transition-all text-gray-600">
                ...
                <div class="border-t border-gray-100 pt-8 flex flex-col md:flex-row items-center justify-between gap-6 text-[10px] sm:text-xs font-bold text-gray-400 tracking-widest uppercase">
