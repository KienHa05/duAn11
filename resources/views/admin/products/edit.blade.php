                    ...
                    <div class="card-body">
                        ...
                        <div class="form-control">
                            ...
                            <textarea 
                                ...
                                rows="4"
                                class="textarea textarea-bordered focus:textarea-primary transition @error('description') textarea-error @enderror">{{ old('description', $product->description) }}</textarea>
                            <label class="label">
            ...
            <div class="space-y-6">
                ...
                <div class="card bg-base-100 shadow-md border border-base-200">
                    <div class="card-body">
                            ...
                            <div id="imagePreview" class="w-full h-64 bg-base-200 rounded-lg border-2 border-dashed border-base-300 flex items-center justify-center overflow-hidden">
                                ...
                                @else
                                    <div class="text-center">
                                        ...
                                        <p class="text-sm text-base-600">Chưa có ảnh</p>
                                    </div>
                                @endif
                            </div>
                        </div>
                        ...
                        <!-- Remove Image Button -->
                        <button type="button" id="removeImageBtn" class="btn btn-sm btn-ghost w-full {{ !$product->image ? 'hidden' : '' }}">
                ...
                <div class="card bg-error/10 shadow-md border border-error/20">
                    <div class="card-body">
                        <h2 class="card-title text-lg font-bold flex items-center gap-2 text-error">
                            <x-heroicon-o-exclamation-triangle class="w-5 h-5" />
                            Vùng nguy hiểm
                        </h2>
                        <p class="text-sm mb-4">Hành động này không thể hoàn tác.</p>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    removeImageBtn.addEventListener('click', function() {
        imageInput.value = '';
        {{ $product->image ? 'imagePreview.innerHTML = `<img src="' . $product->image_url . '" class="w-full h-full object-cover" alt="' . $product->name . '">`;' : 'imagePreview.innerHTML = `<div class="text-center"><svg class="w-12 h-12 mx-auto text-base-400 mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg><p class="text-sm text-base-600">Chưa có ảnh</p></div>`;' }}
    });
