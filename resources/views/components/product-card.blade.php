        ...
        <div class="mt-auto">
            ...
            <div class="flex gap-2 items-center">
                ...
                <button 
                    ...
                    :disabled="!$el.closest('.group').querySelector('[data-stock]')?.dataset.stock > 0"
                    class="w-9 h-9 flex items-center justify-center rounded-xl border-2 border-black text-black hover:bg-black hover:text-white transition-all transform active:scale-90 disabled:opacity-20 disabled:pointer-events-none group/cart cursor-pointer shadow-sm"
                >
